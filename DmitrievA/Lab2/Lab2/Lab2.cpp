	...
	while(command != 4) {
		...
		case 2: {
			...
			Polinom* resUnordered = unorderedTable.find(str);
			 ...
			 if (resUnordered) cout << "Unordered table: " << *resUnordered << endl;
			 else cout << "Unordered table: not found" << endl;
			 if (resAVL) cout << "AVL ordered table: " << *resAVL << endl;
			 else cout << "AVL ordered table: not found" << endl;
			 if (resHash) cout << "Hash ordered table: " << *resHash << endl;
			 else cout << "Hash ordered table: not found" << endl;
			break;
		}
		case 3: {
